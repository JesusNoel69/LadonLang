namespace LadonLang
{
    public class SymbolTable
    {
        ...
        {
            Console.WriteLine("-------------------------------------------------------------------------------------------------------------------------------------------------------------");
            Console.WriteLine("| Name       | Type              | Scope     | DataType   | OffSet  | Size   | Context         | Parameters                     | Identifier of structure   |");
            Console.WriteLine("-------------------------------------------------------------------------------------------------------------------------------------------------------------");
            foreach (var symbol in symbols)
            {
                ...
                Console.WriteLine($"| {symbol.Name,-10} | {symbol.Type ?? "-", -17} | {symbol.Scope, -9} | {symbol.DataType ?? "-", -10} | {offset, -7} | {symbol.Size, -6} | { context, -15} | {parameters, -30} | {symbol.NameOfStructure, -25} |");
            }
            Console.WriteLine("-------------------------------------------------------------------------------------------------------------------------------------------------------------");
        }
